                    ...
                    >
                        ...
                        <div className="border-t border-(--vm-border) p-2">
                            <button
                                ...
                                className="flex w-full cursor-pointer items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-(--vm-text) transition-colors hover:bg-(--vm-surface-2)"
                            >
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className="mt-1 flex w-full cursor-pointer items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-(--vm-danger) transition-colors hover:bg-(--vm-danger)/8 disabled:cursor-not-allowed disabled:opacity-50"
                            >
