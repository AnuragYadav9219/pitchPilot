...
public class ConversationSummaryServiceImpl
        ...
        private String generateSummary(
                ...
                String systemInstruction = """
                                You are the long-term memory manager for VirtualMentor. Your job is to maintain a concise and useful memory of the user's conversation.
                                Combine the existing memory with the new conversation information and return an updated memory.

                                Preserve information that helps VirtualMentor provide better future responses, including:
                                - user's goals
